...
| 11 | B18 | Smoothness wave 2: material language, continuity moments, sound slice, beauty moves | me | open | moved 08-24, the ordering ruling: wave 2 polish, not a gate |
...
| 15 | B8 | Cards remember you between games · play logging. Store proposed 08-11 | Aaron | blocked | his read pending on the proposal. moved 08-24, the ordering ruling: play logging is not needed for twenty friends; his read on the store proposal still owed |
| 16 | B9 | Quick Run | me | open | moved 08-24, the ordering ruling: a new mode does not gate the launch of the existing ones |
...
| 19 | B12 | On-court name tags · the 27 lazy questions · CPU-vs-CPU headless sanity test | me | open | moved 08-24, the ordering ruling: none of the three pieces gates play |
| 20 | B14 | The Gym as a room | me | open | moved 08-24, the ordering ruling: the Gym as a ROOM is scenery; drills already run. The gym BUILD gains urgency only when 110 relocates the drills into it |
| 21 | B13 | Player skills · TV / couch mode · in-game chat · trash talk | me | open | moved 08-24, the ordering ruling: four features the twenty can live without |
