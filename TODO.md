...
| 8 | row 16 | The best fonts, and where to buy them | Aaron | blocked | his ask 08-18, needs a licence decision. 08-25 it became the gate: his D7/D8 answer is *"I feel like this is a font sourcing issue, shouldnt we nail down some fonts first?"*; the sourcing round (free + paid with licences and prices, verified) ran 08-25 and sits on the bible board; blocked on his pick, and the buy if the pick is paid. 08-26 RULED: Druk is out, his words: "I cannot afford Druk so its out of the question"; F narrows to the free faces (Anton, Big Shoulders, Anybody condensed, Archivo wide); 08-26 late: his 'Big Shoulders looks thin' verdict traced to a silent font-fallback in the render (1.2ooo), corrected Black render + the two-voice Anybody answer (condensed structure, wide moments) on the board; specimen round ran 08-26 on his 'Specimens for big shoulders': five guarded pairs (menu, league, endveil incl. the Sedgwick slam, pause, settings-as-control) on the board; awaiting his F ruling |
