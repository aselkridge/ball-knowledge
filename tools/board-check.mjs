...
await sleep(700);
await p.screenshot({path:'/home/user/ball-knowledge/design/shots/board/board.png'});
const el=await p.$('#court, canvas');
if(el)await el.screenshot({path:'/home/user/ball-knowledge/design/shots/board/court.png'});
