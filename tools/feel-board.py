  ...
  <section>
    ...
    <div class="demo">
      <div class="chips" id="clockChips">
        <button class="chip on" data-ms="100">100</button>
        <button class="chip" data-ms="200">200</button>
        <button class="chip" data-ms="320">320</button>
        <button class="chip" data-ms="600">600</button>
        <button class="chip" data-ms="1500">1500</button>
      </div>
...
(function(){{
  ...
  /* R1 */
  var clockMs=100,cm=document.getElementById('clockMover');
