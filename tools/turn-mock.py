...
<div class="wrap">
    ...
    <div class="frames">
      <figure>
        <div class="phone">
          ...
          <div class="dock mine">
            ...
            <div class="row"><b>FREE MOVES</b><span>3 teammates still to step</span></div>
        ...
        <figcaption><b>1 · The handoff, straight into your free moves</b>
          ...
          opens ON the free moves with a live count, and DONE is the only way through
          to the action, so they cannot be skipped by accident or forgotten. Slams only
          fire when the ball changes hands.</span>
        </figcaption>
      </figure>
      ...
      <figure>
        ...
        <figcaption><b>3 · Their turn: lights down, floor lit</b>
          ...
          The bark is the trash talk: big moments only, never every play, with an off
          switch in settings.</span>
        </figcaption>
      </figure>
  ...
  <section>
    ...
    <div class="notes">
      ...
      <p><strong>The dock never covers the court, and that is a law of the build, not
        a hope.</strong> It lives in the dead space under the floor, collapses to a
        slim strip whenever a card is up, and if a layout ever gets tight the dock
        shrinks or its rows turn into a swipeable carousel before a single tile goes
        under it. The build ships with a check that measures the dock against the
        court's edge and fails on one pixel of overlap, on both phone heights.</p>
    </div>
  </section>
