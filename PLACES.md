...
| 2026-08-28 | **SHAPE BEFORE DRESS** (row 206, the holistic re-order). All 189 rows read as one dependency map: the five shape-setters, the three places the current order has us dressing a surface scheduled for demolition (196 above 103; two rulesets live; 194 needing 178 across the twenty), the top of BUILD generated live from TODO.md with each row marked by the wave it moves to or the row that absorbs it, a five-wave proposal, and what stays safe to touch any week. Four options at the bottom, his to rule; nothing is re-sorted in TODO.md until he does. Build: `python3 scratchpad/order-page.py` (the current column regenerates from the file, so republish after any re-order) | https://claude.ai/code/artifact/52d2dbe2-6310-4ec2-9b26-993422f6d039 |
